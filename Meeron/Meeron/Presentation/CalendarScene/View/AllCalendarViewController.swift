...
class AllCalendarViewController:UIViewController {
    ...
    func setupTableView() {
        ...
        yearTableView.register(UINib(nibName: "AllCalendarYearCell", bundle: nil), forCellReuseIdentifier: "AllCalendarYearCell")
    ...
    func setupCollectionView(){
        ...
        monthCollectionView.register(UINib(nibName: "AllCalendarMonthCell", bundle: nil), forCellWithReuseIdentifier: "AllCalendarMonthCell")
