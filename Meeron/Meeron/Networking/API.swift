...
struct API {
    ...
    var host = "dev.meeron.net"
    
    func load<T:Codable>(resource:Resource<T>) -> Observable<T?> {
        return RxAlamofire.requestData(resource.method, resource.url, parameters: resource.parameter, encoding: JSONEncoding.default, headers: resource.headers)
